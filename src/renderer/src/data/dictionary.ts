...
export const DICTIONARY: Dictionary = {
    ...
    ai: {
        ...
        enableAIAssistant: { en: "Enable AI Assistant", de: "AI-Assistent aktivieren" },
        enableAIAssistantDescription: { en: "Enables AI chat and analysis functions", de: "Aktiviert den AI-Chat und Analyse-Funktionen" },
        ollamaServerUrl: { en: "Ollama Server URL", de: "Ollama Server URL" },
        defaultOllamaUrl: { en: "Default: http://localhost:11434", de: "Standard: http://localhost:11434" },
        enterApiKey: { en: "Enter API key", de: "API Key eingeben" },
        test: { en: "Test", de: "Testen" },
        selectModel: { en: "Select model", de: "Modell auswählen" },
        loadingModels: { en: "Loading models...", de: "Lade Modelle..." },
        aiAssistantNote: { en: "Note: The AI assistant can help you find tests, analyze results, and identify problems. Your API key is encrypted and stored locally, never shared with third parties.", de: "Hinweis: Der AI-Assistent kann dir helfen, Tests zu finden, Ergebnisse zu analysieren und Probleme zu identifizieren. Dein API-Key wird verschlüsselt lokal gespeichert und nie an Dritte weitergegeben." },
        localModels: { en: "Local Models", de: "Lokale Modelle" },
