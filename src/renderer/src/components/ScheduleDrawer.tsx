...
const ScheduleDrawer: React.FC<ScheduleDrawerProps> = ({ isOpen, onClose, onSave, initialData, title }) => {
      ...
      <DrawerContent>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-2">
            <Label className="text-gray-600 dark:text-gray-400" htmlFor="name">Name *</Label>
            <Input
              id="name"
              type="text"
              value={name}
          ...
          {/* Form Selection */}
          <div className="space-y-2">
            <Label className="text-gray-600 dark:text-gray-400" htmlFor="formId">Formular *</Label>
            <Select value={formId} onValueChange={setFormId} disabled={isSubmitting}>
          ...
          <div className="space-y-2">
            <Label className="text-gray-600 dark:text-gray-400" htmlFor="paymentMethodId">Bezahlmethode *</Label>
            <Select value={paymentMethodId} onValueChange={setPaymentMethodId} disabled={isSubmitting}>
              <SelectTrigger id="paymentMethodId">
                <SelectValue placeholder="Bezahlmethode auswählen" />
              </SelectTrigger>
              <SelectContent>
                {paymentMethods.map((pm) => (
                  <SelectItem key={pm.id} value={String(pm.id)}>{pm.name} ({pm.type})</SelectItem>
                ))}
              </SelectContent>
            </Select>
          </div>
          ...
          {/* Frequency Selection */}
          <div className="space-y-2">
            <Label className="text-gray-600 dark:text-gray-400" htmlFor="frequency">Häufigkeit *</Label>
          ...
          {frequency === "custom" && (
            <div className="space-y-2">
              <Label className="text-gray-600 dark:text-gray-400" htmlFor="customCron">Cron Ausdruck *</Label>
              <Input
                id="customCron"
                type="text"
                value={customCron}
