...
const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(({ className = "", variant = "primary", size = "md", isLoading = false, disabled, children, condensed, to, href, ...props }, ref) => {
  const baseClasses = "relative inline-flex items-center justify-start rounded transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2 outline-offset-2 disabled:opacity-50 disabled:pointer-events-none";
